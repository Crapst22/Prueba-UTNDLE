      ...
      <div className="text-center relative">
        ...
        <div className="flex items-center justify-center gap-4 mb-4">
          ...
          <div className="text-left">
            <p className="font-semibold text-white">{profesorDelDia.nombre}</p>
        ...
        <div className="grid grid-cols-2 gap-3 mb-4">
          <div className="rounded-xl p-3" style={{ background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.08)' }}>
            <p className="text-lg font-bold text-yellow-400">{partida.intentos.length}</p>
            <p className="text-xs text-white/50">Intentos</p>
          </div>
          <div className="rounded-xl p-3" style={{ background: 'rgba(255,255,255,0.06)', border: '1px solid rgba(255,255,255,0.08)' }}>
